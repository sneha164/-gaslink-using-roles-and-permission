...
<body>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="owl-carousel">
                            ...
                            <div class="card mb-4">
                                ...
                                <img src="{{ asset('storage/images/products/' . $item->image) }}" alt="{{ $item->image}}" height="200px"
                                    class="card-img-top">
                        ...
                        @endforeach
                            {{-- <div class="card">
                                <img src="{{ asset('user/images/lighter.jpg') }}" height="200px"
                                    class="card-img-top">
                                <div class="card-body text-center">
                            ...
                            <div class="card">
                                <img src="{{ asset('user/images/regulator.jpg') }}" height="200px"
                                    class="card-img-top">
                                <div class="card-body text-center">
                            ...
                            <div class="card">
                                <img src="{{ asset('user/images/burner.png') }}" height="200px"
                                    class="card-img-top">
                                <div class="card-body text-center">
                            ...
                            <div class="card">
                                <img src="{{ asset('user/images/stove.jfif') }}" height="200px"
                                    class="card-img-top">
                                <div class="card-body text-center">
                    ...
                    <div class="row text-center  p-2 d-flex align-items-stretch">
                        ...
                        <div class=" col-lg-3 col-md-4 mb-md-0 d-flex align-items-stretch">
                            <div class="card technician-card">
                                <div class="card-up"></div>
                                <div class="avatar mx-auto ">
                                    <img src="{{ asset('user/images/minion.png') }}"
                                        class="rounded-circle img-fluid">
                                </div>
                                <div class="card-body">
                                    <h4>Lisa Cudrow</h4>
    ...
    <section class="copyright">
        <div class="text  p-3">
            <span> © GasLink. All Rights Reserved </span> | Design by: <a href="https://www.facebook.com/essneha.sapkota/" target="_blank">Sneha Sapkota</a> 
        </div>
    </section>
